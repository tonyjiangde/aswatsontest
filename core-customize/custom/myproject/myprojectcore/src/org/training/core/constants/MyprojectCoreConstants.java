...
/**
 * Global class for all MyprojectCore constants. You can add global constants for your extension into this class.
 */
public final class MyprojectCoreConstants extends GeneratedMyprojectCoreConstants
{
	public static final String EXTENSIONNAME = "myprojectcore";


	private MyprojectCoreConstants()
	{
		//empty
	}
